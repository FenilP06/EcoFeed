...
if(!$conn)
{
    ...
    window.location.replace('upcollection.php')</SCRIPT>";
}
...
<h2>Cancel Quantity Update Request</h2>
<br/>
</div>
    ...
    if(isset($_POST['sub']))
    {
        $collect_srno = $_POST['serial'];
        $sql5 = "UPDATE `collection` SET `status`='Cancelled' WHERE `collect_srno` = '$collect_srno'";
