...
if($usercat == 'Farmer')
{
$tsql1 = "SELECT * FROM `distribution` WHERE `fcode` = '$code' ";
...
if(mysqli_num_rows($tquery1) >= 1)
{
    ...
    window.location.replace('udistribution_view.php');</SCRIPT>";
}
}
if($usercat == 'Bio-Plant')
{
$tsql2 = "SELECT * FROM `distribution` WHERE `bcode` = '$code' ";
...
<div class="container">
<br />
    <h2 align="center">Distribution Data</h2>
    <br />
</div>
...
{?>
    <tr>
    <td><?php echo $row['distribute_srno']; ?></td>
