...
<head>
    ...
    <title>Transporter Delete</title>
...
$query = "SELECT * FROM `transportation` WHERE `code`='$code'"   ;
...
while($row=mysqli_fetch_array($result))
{
    ...
    $D4=$row['email'];
    $D5=$row['phone'];
    $D6=$row['vehical_number'];
    $D7=$row['vehical_type'];
    $D8=$row['vehical_capacity'];
    $D9=$row['DL'];
}
...
<h2>Delete Transporter Record</h2>
</div>
<br/>
    <form class="form-horizontal" method="post" action='transportdelete.php'>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="email" readonly name="D4" value="<?php echo $D4; ?>" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-5 control-label">Vehical number</label>
            <div class="col-xs-5">
                <input type="text" readonly name="D6" value="<?php echo $D6; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Vehical type</label>
            <div class="col-xs-5">
                <input type="text" readonly name="D7" value="<?php echo $D7; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div> <div class="form-group">
            <label class="col-sm-5 control-label">Vehical capacity</label>
            <div class="col-xs-5">
                <input type="number" readonly name="D8" value="<?php echo $D8; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Driving lincence</label>
            <div class="col-xs-5">
                <input type="text" readonly name="D9" value="<?php echo $D9; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>

        <div class="form-group">
            <div class="col-sm-offset-5 col-sm-10">
                <input type="submit" class="btn btn-primary" name="submit" value="Click to Delete" />
            </div>
        </div>
    </form>   
