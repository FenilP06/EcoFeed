...
<body id="wrapper">
    ...
    <br />
    <h2 align="center">Farmers List</h2>
    <br />
...
<td><?php echo $row['tland_area'] ?></td>
<td><a href="farmeredit.php?code=<?php echo $code?>" class="btn btn-info" role="button">Edit</a></td>
<td><a href="farmereditdel.php?code=<?php echo $code?>" class="btn btn-danger" role="button">Delete</a></td>
</tr>
