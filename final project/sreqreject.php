...
$sql = "SELECT * FROM `slurry_request` WHERE `code` = '$code' AND `status` = 'pending'";
$query = mysqli_query($conn,$sql);
if(!$query)
{
    echo "<script> alert('unable to fetch record');";
}
...
<head>
    ...
    <title>Reject Waste Request</title>
...
<div class="container"></div>
    ...
    <div class="container" align="center">
        <h2>Reject Slurry Request
        <br></h2>
        
    </div>
        
<form class="form-horizontal" method="post" action='srequestreject.php'>
			<div class="form-group">
			  <label class="col-sm-5 control-label">Farmer Code </label>
			  <div class="col-xs-5">
				<input type="text" readonly="" class="form-control" name="fc" value="<?php echo $r1 ?>" required="" .col-xs-3/>
			...
			<div class="form-group">
			  ...
			  <div class="col-xs-5">
				<input type="text" readonly="" name="nm" value="<?php echo $r2 ?>" required="" class="form-control" .col-xs-3/>
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
				  <input type="number" readonly="" name="pn" value="<?php echo $r3?>" required="" class="form-control" .col-xs-3/>
              ...
              <div class="form-group">
				...
				<div class="col-xs-5">
				  <input type="text" readonly="" name="pn" value="<?php echo $r5?>" required="" class="form-control" .col-xs-3/>
              ...
              <div class="form-group">
				...
				<div class="col-xs-5">
				  <input type="number" readonly="" name="qty" value="<?php echo $r6?>" required="" class="form-control" .col-xs-3/>
              ...
              <div class="form-group">
				...
				<div class="col-xs-5">
				  <input type="date" readonly="" name="dat" value="<?php echo $r7?>" required="" class="form-control" .col-xs-3/>
              ...
              <div class="form-group">
				...
				<div class="col-xs-5">
				  <input type="text" readonly="" name="status" value="<?php echo $r8?>" required="" class="form-control" .col-xs-3/>
</div>
			  </div>
			<div class="form-group">
			  <div class="col-sm-offset-5 col-sm-10">
				<input type="submit" class="btn btn-primary"name="sub" value="Reject"/> 
			  </div>
			</div>
		  </form>
