...
<h2>Farmer Master Delete</h2>
</div>
<br/>
    <form class="form-horizontal" method="post" action='farmerdelete.php'>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="number" readonly  name="D3" value="<?php echo $D3; ?>" required="" class="form-control" .col-xs-3 />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="email" readonly  name="D4" value="<?php echo $D4; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Address </label>
            <div class="col-xs-5">
                <input type="text" readonly  name="D5" value="<?php echo $D5; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
