        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="volunteeredit.php?code=<?php echo $code ?>" class="btn btn-info" role="button">Edit</a></td>
                    <td><a href="volunteereditdel.php?code=<?php echo $code ?>" class="btn btn-danger" role="button">Delete</a></td>
                </tr>
