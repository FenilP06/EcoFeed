...
<div class="container">
    ...
    <div class="container" align="center">
		...
		<form class="form-horizontal" method="post" action='uwrequestview.php'>
			<div class="form-group">
			  <label class="col-sm-5 control-label">Donar Code </label>
			  <div class="col-xs-5">
				<input type="text" class="form-control" name="dc" required="" .col-xs-3/>
              </div>
			</div>
            <div class="form-group">
    ...
    <!-- <table>
        <form action='uwrequestview.php' method="post">
            <tr>
                <td>Donar code </td>
