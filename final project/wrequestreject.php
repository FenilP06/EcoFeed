...
<head>
    ...
    <title>Waste Request Reject</title>
...
<h2>Waste Request Reject</h2>
</div>
<br/>
    <form class="form-horizontal" method="post" action='wreqreject.php'>
       
        <div class="form-group">
            <label class="col-sm-5 control-label">Donar Code </label>
            <div class="col-xs-5">
                <input type="text" readonly="" class="form-control" name="dc" value="<?php echo $r1; ?>" required=" " .col-xs-3 />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="text" readonly="" name="pn" value="<?php echo $r3; ?>" required="" class="form-control" .col-xs-3 />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="email" readonly="" name="add" value="<?php echo $r4; ?>" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Approx Qunatity </label>
            <div class="col-xs-5">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="text" readonly="" name="D6" value="<?php echo $r6; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
