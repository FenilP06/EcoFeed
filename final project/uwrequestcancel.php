...
$sql = "SELECT * FROM `waste_request` WHERE `dcode` = '$code' AND `status` = 'pending'";
...
<head>
    ...
    <title>Cancel waste Request</title>
...
<div class="container">
    ...
    <div class="container" align="center">
        <h2>Cancel Waste Request</h2>
        </div>
        <br/>

		<form class="form-horizontal" method="post" action='uwreqcancel.php'>
			<div class="form-group">
			  <label class="col-sm-5 control-label">Donar Code </label>
			  <div class="col-xs-5">
				<input type="text" readonly="" class="form-control" name="dc" value="<?php echo $r1?>" required="" />
			...
			<div class="form-group">
              ...
              <div class="form-group">
				...
				<div class="col-xs-5">
				  <input type="text" readonly="" name="add" value="<?php echo $r4?>" required=""  class="form-control" .col-xs-3/>
				  
				</div>
			  </div>
              <div class="form-group">
				<label class="col-sm-5 control-label">Approx Quantity </label>
				<div class="col-xs-5">
				  <input type="number" readonly="" name="apq" value="<?php echo $r5?>" required=""  class="form-control" .col-xs-3/>
			  ...
			  <div class="form-group">
				...
				<div class="col-xs-5">
				  <input type="text" readonly="" name="status" value="<?php echo $r6?>" required=""  class="form-control" .col-xs-3/>
				  
				</div>
			  </div>
			<div class="form-group">
			  <div class="col-sm-offset-5 col-sm-10">
				<input type="submit" class="btn btn-primary"name="sub" value="Cancel"/> 
			  </div>
			</div>
		  </form>
