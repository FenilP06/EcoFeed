...
function validate()
    {
        var phone = document.reg.pn.value;
        if(phone.length>10 || phone.length<10)
        {
            alert("Please 10 digit phone number ");
            document.reg.pn.focus();
            return false;
        }
        return (true);
    }    
...
<br/>
    <form class="form-horizontal" method="post" action='registrationupdate.php' name="reg" onsubmit="return validate();">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="email" name="em" value="<?php echo $r4; ?>" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Phone number </label>
            <div class="col-xs-5">
                <input type="number" name="pn" value="<?php echo $r5; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Address </label>
            <div class="col-xs-5">
                <input type="text" name="add" value="<?php echo $r6; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Security Question </label>
            <div class="col-xs-5">
                <input type="text" readonly="" name="ques" value="<?php echo $r7; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Security Answer </label>
            <div class="col-xs-5">
                <input type="text" name="ans" value="<?php echo $r8; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
