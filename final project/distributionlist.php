...
<div class="container">
<br />
    <h2 align="center">Distribution Record Update</h2>
    <br />
</div>
...
{ $dsrno = $row['distribute_srno'];
    ?>
    <tr>
    <td><?php echo $dsrno; ?></td>
    ...
    <td><a href = "distributionedit.php?dsrno=<?php echo $dsrno?>" class="btn btn-info" role="button">Edit</a></td>
    <td><a href = "distributiondeledit.php?dsrno=<?php echo $dsrno?>" class="btn btn-danger" role="button">Delete</a></td>
    </tr>
