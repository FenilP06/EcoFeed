...
<div class="container">
    ...
    <div class="container" align="center">
        <h2>Request for Slurry</h2>
        </div>
        <br/>

		<form class="form-horizontal" method="post" action='usrequest.php'>
			<div class="form-group">
			  <label class="col-sm-5 control-label">Farmer Code </label>
			  <div class="col-xs-5">
				<input type="text" class="form-control" name="fcode" required="" .col-xs-3/>
			...
			<div class="form-group">
			  ...
			  <div class="col-xs-5">
				<input type="number" name="quantity" required="" class="form-control" .col-xs-3/>
				
			  </div>
			</div>
			<div class="form-group">
				<label class="col-sm-5 control-label">Last distribution date </label>
				<div class="col-xs-5">
				  <input type="date" name="ldate"  class="form-control" .col-xs-3/>
