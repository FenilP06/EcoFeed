...
<td><a href="registrationedit.php?uname=<?php echo $uname;?>"  class="btn btn-info" role="button">Edit</a></td>
<td><a href="registrationdeledit.php?uname=<?php echo $uname;?>"  class="btn btn-danger" role="button">Delete</a></td>
</tr>
<?php } ?>
</table>
</div>
