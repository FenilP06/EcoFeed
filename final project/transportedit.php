...
<h2>Update Transporter Details</h2>
</div>
<br/>
    <form name="reg" onsubmit="return validate();" class="form-horizontal" method="post" action='transportupdate.php'>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="numebr" name="D5" value="<?php echo $D5; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Vehical number</label>
            <div class="col-xs-5">
                <input type="text" name="D6" value="<?php echo $D6; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="number" name="D8" value="<?php echo $D8; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Driving lincence</label>
            <div class="col-xs-5">
                <input type="text" name="D9" value="<?php echo $D9; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
