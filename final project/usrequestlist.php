...
$fcode = $_POST['fc'];
$query = "SELECT * FROM `slurry_request` WHERE `status` = 'pending' AND `code` = '$fcode' ";
...
<td><a href="usrequest_cancel.php?code=<?php echo $code ?>" class="btn btn-danger" role="button">Reject</a></td>
</tr>
