...
<body id="wrapper">
    ...
    <div class="container"></div>
        ...
        <br />
        <h2 align="center">Transporters List</h2>
        <br />
        <table class="table table-bordered">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="transportedit.php?code=<?php echo $code ?>" class="btn btn-info" role="button">Edit</a></td>
                    <td><a href="transporteditdel.php?code=<?php echo $code ?>" class="btn btn-danger" role="button">Delete</a></td>
                </tr>
                <?Php }
            mysqli_close($conn); ?>
