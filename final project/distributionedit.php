...
<form class="form-horizontal" method="post" action='distributionupdate.php'>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-5">
              <input type="text" name="D7" value="<?php echo $D7?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
