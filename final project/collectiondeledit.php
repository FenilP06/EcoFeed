...
if ($wastecat=="EdibleFood") {
  ...
  echo "Error in collection deletedediit!!!";
}
...
<div class="container">
<br />
    <h2 align="center">Collection Record Delete</h2>
    <br />
</div>

<?php if ($wastecat == "EdibleFood"): ?>
  <form class="form-horizontal" method="post" action='collectiondelete.php'>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
              <input type="text" readonly=""  name="dc" value="<?php echo $c3; ?>" required="" class="form-control" .col-xs-3/>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-5">
              <input type="text" readonly="" name="vc" value="<?php echo $c5?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-5">
              <input type="text" readonly="" name="tc" value="<?php echo $c7?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-5">
              <input type="number" readonly="" name="wq" value="<?php echo $c12?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-5">
              <input type="text" readonly=""  name="status" value="<?php echo $c16?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
        <div class="form-group">
  ...
  <form class="form-horizontal" method="post" action='collectiondelete.php'>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-5">
              <input type="text" readonly="" name="bc" value="<?php echo $c9?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
