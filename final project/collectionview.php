...
<div class="container">
<br />
    <h2 align="center">Collection Records</h2>
    <br />
</div>
...
<?php if ($wastecat == "EdibleFood"): ?>
    ...
    <div class="table-responsive">
                ...
                <th>Vehical_Type</th>
                <th>Vehical_Capacity</th>
                <th>Location</th>
                <th>Approx_Quantity</th>    
                <th>Waste_Quantity</th>
                <th>Status</th>
                </tr>
                <?php
                $sql = "SELECT * FROM `collection_edb`";
                $query=mysqli_query($conn,$sql);
                while($row = mysqli_fetch_assoc($query))
                {
                ?>
                <tr>
                <td><?php echo $row['collectedb_srno'] ?></td>
                ...
                <button id="printPDF">Download Report</button>  
                </div>
...
<script>
    document.getElementById('printPDF').addEventListener('click', function() {
        ...
        var source = document.querySelector('.table-responsive');
        ...
        html2canvas(source, {
            ...
            onrendered: function(canvas) {
                ...
                pdf.save('CollectionRecords.pdf');
            }
        });
    });
</script>
