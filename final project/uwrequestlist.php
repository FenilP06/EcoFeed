...
$dcode = $_POST['dc'];
$sql = "SELECT * FROM `waste_request` WHERE `dcode` = '$dcode' AND `status` = 'pending' ";
...
<div class="container">
<br />
    <h2 align="center">Pending Waste Requests</h2>
    <br />
</div>
...
<td><a href="uwrequestcancel.php?code=<?php echo $code?>" class="btn btn-danger" role="button">Cancel</a></td>
</tr>
<?php 
} mysqli_close($conn);
?>
