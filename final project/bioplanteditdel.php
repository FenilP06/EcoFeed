...
$query = "SELECT * FROM `bio_plant` WHERE `code`='$code'"   ;
...
<h2>Bio-Plant Master Delete</h2>
</div>
<br/>
    <form class="form-horizontal" method="post" action='bioplantdelete.php' onsubmit="return validate();" name ="reg">
        ...
        <div class="form-group">
            <label class="col-sm-5 control-label">Waste price</label>
            <div class="col-xs-5">
                <input type="number" readonly name="D6" value="<?php echo $D6; ?>" required=""  class="form-control" .col-xs-3  />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Slurry price </label>
            <div class="col-xs-5">
                <input type="number" readonly name="D7" value="<?php echo $D7; ?>" required=""  class="form-control" .col-xs-3  />
            </div>
        </div>
        <div class="form-group">
