...
$sql = "SELECT * FROM `waste_request` WHERE `status` = 'pending' ";
...
<head>
    ...
    <title>Waste request list</title>
...
<div class="container">
<br />
    <h2 align="center">Waste Requests</h2>
    <br />
</div>
...
<td><?php echo $row['approx_quantity']; ?></td>
<td><?php echo $row['wastecat']; ?></td>
<td><?php echo $row['status']; ?></td>

<td><a href="collection.php?code=<?php echo $code; ?>" class="btn btn-info" role="button">Approve</a></td>
<td><a href="wrequestreject.php?code=<?php echo $code; ?>" class="btn btn-danger" role="button">Reject</a></td>
</tr>
<?php 
} mysqli_close($conn);
?>
