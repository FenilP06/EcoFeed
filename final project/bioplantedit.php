...
function validate()
        {
            ...
            if(phone.length<10 || phone.length>10)
                ...
                // {
                //     alert("Don't insert numeric value into name field");
                //     document.reg.D2.focus();
                //     return false;
                // }
...
<h2>Bio-Plant Master Update</h2>
</div>
<br/>
    <form class="form-horizontal" method="post" action='bioplantupdate.php' onsubmit="return validate();">
