...
<body id="wrapper">
    ...
    <br />
    <h2 align="center">Bio-Plants list</h2>
    <br />
...
<td><a href="bioplantedit.php?code=<?php echo $code?>" class="btn btn-info" role="button">Edit</a></td>
<td><a href="bioplanteditdel.php?code=<?php echo $code?>" class="btn btn-danger" role="button">Delete</a></td>
<!-- <td><a href="bioplantdelete.php?code=<?php // echo $code?>">Delete</a></td> -->
</tr>
