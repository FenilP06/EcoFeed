...
<body id="wrapper">
    ...
    <div class="container" align="center">
        <h2>Request for Waste Collection</h2>
        </div>
        <br />

		<form class="form-horizontal" method="post" action='uwrequest.php' >
			<div class="form-group">
			  <label class="col-sm-5 control-label">Donar Code </label>
			  <div class="col-xs-5">
				<input type="text" class="form-control" name="dcode" required="" .col-xs-3 />
			...
			<div class="form-group">
			  ...
			  <div class="col-xs-5">
				<input type="text" name="appq" required="" class="form-control" .col-xs-3/>
				
			  </div>
			</div>

            <div class="form-group">
                <label class="col-sm-5 control-label">Food Waste Type </label>
                <div class="col-xs-5">
                  <select name="wastecat" class="form-control">
                    <option class="option">EdibleFood</option>
                    <option class="option">InedibleFood</option>
                </select>
                </div>
            </div>
