...
<h2>Delete Volunteer Record</h2>
</div>
<br/>
    <form class="form-horizontal" method="post" action='volunteerdelete.php'>
       
        <div class="form-group">
            <label class="col-sm-5 control-label">Code </label>
            <div class="col-xs-5">
                <input type="text" readonly class="form-control" name="D1" value="<?php echo $D1?>" required=" " />
            </div>
        </div>
        <div class="form-group">
