...
<div class="container">
    ...
    <div class="container" align="center">
        <h2>Slurry Request Cancel</h2>
        </div>
        <br/>
        <?php
        $sql = "SELECT * FROM `slurry_request` WHERE `code` = '$code' ";
        ...
        ?>
        <form class="form-horizontal" method="post" action='usrequestcancel.php' >
        <div class="form-group">
			  <label class="col-sm-5 control-label">Code </label>
			  <div class="col-xs-5">
				<input type="text" class="form-control" name="code" readonly="" value="<?php echo $rcode?>" required="" .col-xs-3 />
            ...
            <div class="form-group">
			  ...
			  <div class="col-xs-5">
				<input type="text" class="form-control" name="name" readonly="" value="<?php echo $name?>" required="" .col-xs-3 />
				<!-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email"> -->
			  </div>
			</div>
            <div class="form-group">
			  ...
			  <div class="col-xs-5">
				<input type="text" class="form-control" name="address" readonly="" value="<?php echo $address?>" required="" .col-xs-3 />
				<!-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email"> -->
			  </div>
			</div>
            <div class="form-group">
			  ...
			  <div class="col-xs-5">
				<input type="text" class="form-control" name="quantity" readonly="" value="<?php echo $quantity?>" required="" .col-xs-3 />
				<!-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email"> -->
			  </div>
			</div>
			<div class="form-group">
			  ...
			  <div class="col-xs-5">
				<input type="date" name="date" value="<?php echo $date?>" readonly="" required="" class="form-control" .col-xs-3/>
            ...
            <div class="form-group">
			  ...
			  <div class="col-xs-5">
				<input type="text" class="form-control" name="status" readonly="" value="<?php echo $status?>" required="" .col-xs-3 />
				<!-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email"> -->
			  </div>
			</div>
