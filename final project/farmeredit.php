...
function validate()
    {
        var phone = document.reg.D3.value;
        var income = document.reg.D6.value;
        var total_land = document.reg.D7.value;
        if(phone.length<10 || phone.length>10)
                {
                    alert("Please Enter 10 digit phone number");
                    document.reg.D3.focus();
                    return false;
                }
                if(income > 300000)
                {
                    alert ("Cannot register farmer with annual income more than 300000");
                    document.reg.D6.focus();
                    return false;
                }
                if(total_land > 5)
                {
                    alert ("Cannot register farmer with land more than 5 bigha");
                    document.reg.D7.focus();
                    return false;
                }
...
$query = "SELECT * FROM `farmer` WHERE `code`='$code'"   ;
...
<h2>Farmer Master Edit</h2>
</div>
<br/>
    <form name="reg" onsubmit="return validate();" class="form-horizontal" method="post" action='farmerupdate.php'>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="number" name="D3" value="<?php echo $D3; ?>" required="" class="form-control" .col-xs-3 />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="text" name="D5" value="<?php echo $D5; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Annual Income </label>
            <div class="col-xs-5">
                <input type="number" name="D6" value="<?php echo $D6; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Total Land </label>
            <div class="col-xs-5">
                <input type="number" name="D7" value="<?php echo $D7; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
