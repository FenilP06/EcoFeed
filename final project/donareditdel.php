...
<div class="container"></div>
    ...
    $query = "SELECT * FROM `donar` WHERE `code`='$code'";
...
<h2>Update Donar Details</h2>
</div>
<br/>
    <form name="reg" onsubmit="return validate();" class="form-horizontal" method="post" action='donardelete.php'>
