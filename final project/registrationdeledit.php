...
$sql = "select `usercat`,`username`,`name`,`email`,`phone`,`address`,`question`,`answer` from `users` where `username` = '$uname' ";
...
<h2>Registration Record Delete</h2>
</div>
<br/>
    <form class="form-horizontal" method="post" action='registrationdelete.php'>
       
        <div class="form-group">
            <label class="col-sm-5 control-label">User Category </label>
            <div class="col-xs-5">
                <input type="text" readonly="" class="form-control" name="ucat" value="<?php echo $r1; ?>" required=" " .col-xs-3 />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="text" readonly="" name="unm" value="<?php echo $r2 ?>" required="" class="form-control" .col-xs-3 />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="text" readonly="" name="nm" value="<?php echo $r3; ?>" required="" class="form-control" .col-xs-3 />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="email" readonly="" name="em" value="<?php echo $r4; ?>" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Phone number </label>
            <div class="col-xs-5">
                <input type="number" readonly="" name="pn" value="<?php echo $r5; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Address </label>
            <div class="col-xs-5">
                <input type="text" readonly="" name="add" value="<?php echo $r6; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Security Question </label>
            <div class="col-xs-5">
                <input type="text" readonly="" readonly="" name="ques" value="<?php echo $r7; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">Security Answer </label>
            <div class="col-xs-5">
                <input type="text" readonly="" name="ans" value="<?php echo $r8; ?>" required="" class="form-control" .col-xs-3 />
            </div>
        </div>
        <div class="form-group">
