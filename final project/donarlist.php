        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="donaredit.php?code=<?php echo $code ?>" class="btn btn-info" role="button">Edit</a></td>
                    <td><a href="donareditdel.php?code=<?php echo $code ?>" class="btn btn-danger" role="button">Delete</a></td>
                </tr>
            <?Php }
            mysqli_close($conn); ?>
