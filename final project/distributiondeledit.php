...
<head>
    ...
    <title>Distribution Delete</title>
...
<?php
$dsrno=$_REQUEST['dsrno'];
$conn=mysqli_connect('localhost','root','','ckb');
if(!$conn)
{
    echo "Failed to connect to database";
}
$query = "SELECT * FROM `distribution` WHERE `distribute_srno`='$dsrno'"   ;
$result = mysqli_query($conn,$query);
while($row=mysqli_fetch_assoc($result))
{
    $D1=$row['distribute_srno'];
    $D2=$row['fcode'];
    $D3=$row['fname'];
    $D4=$row['fphone'];
    $D5=$row['approved_quantity'];
    $D6=$row['Rdate'];
    $D7=$row['bcode'];
    $D8=$row['bname'];
    $D9=$row['bphone'];
...
<div class="container">
<br />
    <h2 align="center">Distribution Edit</h2>
    <br />
</div>
<form class="form-horizontal" method="post" action='distributiondelete.php'>
        <div class="form-group">
          <label class="col-sm-5 control-label">Distribution Srno. </label>
          <div class="col-xs-5">
        ...
        <div class="form-group">
          <label class="col-sm-5 control-label">Code of farmer</label>
          <div class="col-xs-5">
            <input type="text" readonly="" name="D2" value="<?php echo $D2?>" required="" class="form-control" .col-xs-3/>
            
          </div>
        </div>
        <div class="form-group">
            <label class="col-sm-5 control-label">name of farmer  </label>
            <div class="col-xs-5">
              <input type="text" readonly="" name="D3" value="<?php echo $D3; ?>" required="" class="form-control" .col-xs-3/>
              
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-5 control-label">phone no. of farmer </label>
            <div class="col-xs-5">
              <input type="number" readonly="" name="D4" value="<?php echo $D4?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-5 control-label">Approved Quantity </label>
            <div class="col-xs-5">
              <input type="number" readonly="" name="D5" value="<?php echo $D5?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-5 control-label">Request Date </label>
            <div class="col-xs-5">
              <input type="date" readonly="" name="D6" value="<?php echo $D6?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-5 control-label">Code of Bioplant </label>
            <div class="col-xs-5">
              <input type="text" readonly="" name="D7" value="<?php echo $D7?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-5 control-label">Name of Bio plant </label>
            <div class="col-xs-5">
              <input type="text" readonly="" name="D8" value="<?php echo $D8?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-5 control-label">Phone no. of Bio plant </label>
            <div class="col-xs-5">
              <input type="number" readonly="" name="D9" value="<?php echo $D9?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-5 control-label">Approved date </label>
            <div class="col-xs-5">
              <input type="date" readonly="" name="D10" value="<?php echo $D10?>" required="" class="form-control" .col-xs-3/>
            </div>
          </div>
         <div class="form-group">
          <div class="col-sm-offset-5 col-sm-10">
            <input type="submit" class="btn btn-primary"name="sub" value="Click to Delete"/> 
            </div>
          </div>
        </div>
      </form>
